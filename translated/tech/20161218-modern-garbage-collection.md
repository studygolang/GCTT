...
<!-- specturm 无法理解？ 问题吗？ -->
<!-- As they are non-interactive pause times don’t matter at all, 不确定主语是谁 -->
<!-- 这不是一个简单的问题！在高端，您还可以拥有大批量作业。因为它们是非交互式，暂停时间根本不重要，只有总运行时间。在这种情况下，您最好使用最大化吞吐量的算法，即完成有用工作与收集时间的比率。 -->
